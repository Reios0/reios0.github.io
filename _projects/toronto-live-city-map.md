...
# Table of contents
  ...
  3. [Tech stack](#stack)
    ...
    - [Code quality](#stack-quality)
    - [CI/CD](#stack-cicd)
    - [Hosting & SSL](#stack-host)
    - [Domain & DNS](#stack-domain)
  4. [Architecture](#architecture)
  5. [Technical challenges](#challenges)
    - [Normalizing seven data sources into one](#challenges-normalizing)
    - [Rendering thousands of markers without slowing down](#challenges-rendering)
    - [Fixing a memory spike in a 4-million-row file](#challenges-memory)
    - [Making an interactive map accessibility](#challenges-accessibility)
  6. [Other engineering decisions](#decisions)
...
## <a id="stack" />Tech stack

### <a id="stack-frontend" />Frontend
...
### <a id="stack-backend" />Backend

- Node.js
- Express
- TypeScript

### <a id="stack-communication" />Communication

- REST (static and on-demand details)
- Server-sent events (live updates)

### <a id="stack-testing" />Testing

- Vitest

### <a id="stack-quality" />Code quality

- ESLint
- Prettier

### <a id="stack-cicd" />CI/CD

- GitHub Actions (linting and tests)
- Railway (automatic deploy)

### <a id="stack-host" />Hosting & SSL

- Railway

### <a id="stack-domain" />Domain & DNS

- Porkbun

## <a id="architecture" />Architecture
...
## <a id="challenges" />Technical challenges

### <a id="challenges-normalizing" />Normalizing seven data sources into one
...
### <a id="challenges-rendering" />Rendering thousands of markers without slowing down
...
### <a id="challenges-memory" />Fixing a memory spike in a 4-million-row file
...
### <a id="challenges-accessibility" />Making an interactive map accessible
...
## <a id="decisions" />Other engineering decisions
